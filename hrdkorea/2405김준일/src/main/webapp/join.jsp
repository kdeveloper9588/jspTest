...
try {//성공했을때
	...
	Statement stmt = con.createStatement(); //sql 실행을 위해 stmt를 준비!!
	ResultSet rs = stmt.executeQuery("select max(custno)+1 as custno from member_tbl_02"/*"이 자리에 내가 오라클에서 불러오고 싶은 SQL 문장 입력"*/);
...
%>
			...
			<tr>
				<td colspan = '2'>
				<input type = 'submit' value = '등록' onclick = "return joinCheck()"> <!--데이터베이스에 전송 가능  --> 
